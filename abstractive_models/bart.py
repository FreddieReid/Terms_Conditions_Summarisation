...
training_args = Seq2SeqTrainingArguments(predict_with_generate=True, output_dir= output_dir, per_device_train_batch_size=2,
                                         per_device_eval_batch_size=2, num_train_epochs=4, evaluation_strategy = "epoch",weight_decay=0.01,learning_rate=2e-5, 
                                         logging_steps = 2, gradient_accumulation_steps = 36, skip_memory_metrics = False, run_name = 'bart-summarization',
